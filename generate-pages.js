...
const CORE_PAGES = ['', 'snapshot', 'calculator', 'jnctn', 'resources', 'contact', 'unionhistory', 'ibewhistory']; // existing top-level pages, added to sitemap
/* =========================================================================== */
