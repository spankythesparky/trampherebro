...
function footer() {
  return `<footer><div class="inner"><div><b>TrampHereBro</b> — built by a traveler, for travelers.</div>
...
<p class="credit">Proudly made by Noah "<b>Spanky The Sparky</b>" — IBEW Journeyman</p></div></footer>`;
}
