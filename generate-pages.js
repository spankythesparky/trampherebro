...
const CORE_PAGES = ['', 'snapshot', 'calculator', 'jnctn', 'resources', 'contact', 'unionhistory', 'ibewhistory', 'unionretirement']; // existing top-level pages, added to sitemap
/* =========================================================================== */
...
<nav class="nav"><a href="/"${on('home')}>Board</a><a href="/snapshot"${on('snapshot')}>Daily Update</a><a href="/calculator"${on('calculator')}>Pay Calculator</a><a href="/resources"${on('resources')}>Resources</a><a href="/unionretirement"${on('unionretirement')}>Union Retirement</a><span class="navdd"><a href="/unionhistory"${on('unionhistory')}${on('ibewhistory')}>History<svg class="caret" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 9l6 6 6-6"/></svg></a><span class="ddmenu"><a href="/unionhistory">Union History</a><a href="/ibewhistory">IBEW History</a></span></span><a href="/contact"${on('contact')}>Contact</a><a href="/jnctn" style="background:var(--orange);color:#fff;padding:6px 13px;border-radius:8px;font-weight:700;white-space:nowrap">Join JNCTN</a></nav>
</div></div>`;
}
function footer() {
...
(async function main() {
  ...
  fs.writeFileSync(path.join(SITE_DIR, 'unionretirement.html'), retirementPage()); console.log('  wrote unionretirement.html');
