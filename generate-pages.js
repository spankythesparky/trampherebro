...
<nav class="nav"><a href="/"${on('home')}>Board</a><a href="/snapshot"${on('snapshot')}>Daily Update</a><a href="/calculator"${on('calculator')}>Pay Calculator</a><a href="/resources"${on('resources')}>Resources</a><a href="/unionhistory"${on('unionhistory')}>Union History</a><a href="/ibewhistory"${on('ibewhistory')}>IBEW History</a><a href="/contact"${on('contact')}>Contact</a><a href="/jnctn" style="background:var(--orange);color:#fff;padding:6px 13px;border-radius:8px;font-weight:700;white-space:nowrap">Join JNCTN</a></nav>
</div></div>`;
}
function footer() {
